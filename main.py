...
if __name__ == '__main__':
    ...
    max_nfe = 300  # Determines the total number of offspring that are created
    ...
    # Produce figure(s)
    save = True
    visualizations = Visualization(save, model_name, seeds, max_nfe, depth, epsilons, gamma, tau,
