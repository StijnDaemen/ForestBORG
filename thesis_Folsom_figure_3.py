...
if __name__ == '__main__':
    ...
    # Produce figure
    save = True
    visualizations = VisualizationDiscrete(save, model_name, seeds, max_nfe, depths, epsilons, gammas, tau, restart_intervals, version, controllability_map=True)
    visualizations.controllability_map_thesis_figure_3()
