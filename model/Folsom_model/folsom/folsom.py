...
class Folsom():
    ...
    def __init__(self, datafile, sd, ed,
        ...
        self.D = np.loadtxt('model/Folsom_model/folsom/data/demand.txt')[self.dowy]
        ...
        if self.cc:
            self.annQs = pd.read_csv(
                'model/Folsom_model/folsom/data/folsom-cc-annQ-MA30.csv', index_col=0, parse_dates=True)
            self.lp3s = pd.read_csv(
                'model/Folsom_model/folsom/data/folsom-cc-lp3-kcfs.csv', index_col=0, parse_dates=True)
            self.wycs = pd.read_csv(
                'model/Folsom_model/folsom/data/folsom-cc-wycentroid.csv', index_col=0, parse_dates=True)
