...
def optimization_RICE_ForestBorg_continuous(save_location, model_name, seed, max_nfe, depth, epsilons, gamma, tau,
                                            restart_interval, version,
...
if __name__ == '__main__':
    ...
    # epsilons = [0.01, 1000, 0.01, 10]  # Folsom
    gamma = 4  # Sets the population-to-archive ratio
    tau = 0.02  #
    restart_interval = 5000
    seeds = [17]  # , 42, 104, 303, 902]
    for seed in seeds:
        optimization_RICE_ForestBorg_continuous(save_location, model_name, seed, max_nfe, depth, epsilons, gamma, tau,
                                                restart_interval, version,
                                                scenario=None, scenario_name=None)
    ...
    # Produce figure
    save = True
    Visualization(save, model_name, seeds, max_nfe, depth, epsilons, gamma, tau, restart_interval,
                  version).search_operator_dynamics_thesis_figure_2()
